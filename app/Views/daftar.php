...
<div class="col-lg-8 d-flex align-items-stretch">
            <div class="card d-flex" style="width : 100%">
              <div class="card-body p-8">
                ...
                <a href="<?= base_url('home/t_daftar') ?>"><button class="btn btn-primary">Tambah</button></a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          ...
                          <a href="<?= base_url('home/delete_main' . $key->id_pengunjung) ?>"><button class="btn btn-danger">
                          Delete
                          </button></a>
                        </td>
                      <?php } ?>                     
